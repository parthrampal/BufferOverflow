...
# from the stack.
#
gcc -m32 -o call_shellcode -fno-stack-protector -z noexecstack call_shellcode.c
#
...
#
gcc -m32 -o exploit -fno-stack-protector -z noexecstack exploit.c
#
# compile the vulnerable program with no stack protector
# and allow execution from the stack
#
gcc -g -m32 -o stack -z execstack stack.c
